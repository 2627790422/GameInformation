...
const REFERENCE_DIR = process.env.VAULT_PATH
  ...
  : path.join('C:\\Users\\jiehuiyang\\Documents\\Obsidian Vault');
const VAULT_ROOT = process.env.VAULT_PATH || path.join(REFERENCE_DIR, '游戏设计');

const PIPELINES = [
  { pipeline: '微信资讯', stage: '资讯', dir: '游戏资讯/资讯' },
  { pipeline: '游戏跟踪', stage: '分析', dir: '游戏跟踪/已分析' },
  { pipeline: '自主采集', stage: '拆解', dir: '自主采集/拆解/拆解结果' },
